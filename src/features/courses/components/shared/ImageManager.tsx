...
interface ImageManagerProps {
  courseId: string
  basePath: string // '/admin/courses' or '/instructor/courses'
}

export function ImageManager({ courseId, basePath }: ImageManagerProps) {
    ...
    <div>
      ...
      <nav className="mb-6 text-sm text-gray-600 dark:text-gray-400">
        <ol className="flex items-center gap-2">
          <li>
            <a href={basePath.split('/').slice(0, 2).join('/')} className="hover:text-gray-900 dark:hover:text-white">
              {basePath.includes('admin') ? 'Admin' : 'Instructor'}
            </a>
          </li>
          <li>/</li>
          <li>
      ...
      <div className="mb-6">
        <Button
          variant="ghost"
          onClick={() => router.push(`${basePath}/${courseId}/edit`)}
