...
import { Plus, Loader2, Trash2, Eye, EyeOff, Sparkles } from 'lucide-react'
  ...
  if (!course) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen">
        ...
        <Button variant="primary" onClick={() => router.push('/instructor/courses')}>
          Volver a Mis Cursos
        </Button>
      </div>
    )
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <nav className="mb-6 text-sm text-gray-600 dark:text-gray-400">
        <ol className="flex items-center gap-2">
          <li>
            <a href="/instructor/dashboard" className="hover:text-gray-900 dark:hover:text-white">
              Instructor
            </a>
          </li>
          <li>/</li>
      ...
      <section className="mb-12">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Button
            variant="outline"
            onClick={() => router.push(`/instructor/courses/${courseId}/images`)}
